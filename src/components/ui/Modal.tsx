...
const modal = tv({
  slots: {
    modalBase:
      "fixed top-0 bottom-0 rounded-md shadow-lg z-50 max-w-11/12 lg:max-w-3/4 bg-slate-200 dark:bg-zinc-800 overflow-hidden",
    modalHeader:
      "flex justify-between items-center border-b-2 space-x-8 text-white border-slate-400 dark:border-zinc-900 p-4 bg-bar-gradient",
