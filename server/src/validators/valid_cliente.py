...
class ValidCliente(BaseModel):
    ...
    apelido: Annotated[
        Optional[str], Field(max_length=MAX_CLIENTE_APELIDO_LENGTH, default=None)
    ]
    ...
    logradouro: Annotated[
        Optional[str], Field(max_length=MAX_LOGRADOURO_LENGTH, default=None)
    ]
    ...
    uf: Annotated[
        Optional[str], Field(min_length=UF_LENGTH, max_length=UF_LENGTH, default=None)
    ]
    cep: Annotated[
        Optional[str], Field(min_length=CEP_LENGTH, max_length=CEP_LENGTH, default=None)
    ]
    email: Annotated[
        Optional[EmailStr], Field(max_length=MAX_EMAIL_LENGTH, default=None)
    ]
