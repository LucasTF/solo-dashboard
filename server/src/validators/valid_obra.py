...
from src.validators.validator_functions import validate_cep, validate_tipo_logo, validate_uf
...
class ValidObra(BaseModel):
    ...
    def validate_dates(self):
        ...
        if data_inicio > data_fim:
            raise ValueError("Data de conclusão da obra não pode ser anterior a data de início.")
