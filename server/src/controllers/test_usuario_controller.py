...
class UsuarioControllerTestCase(TestCase):
    ...
    def test_create_without_id(self):
        ...
        with mock.patch.object(
            self.__controller,
            "_UsuarioController__validate_usuario",
            return_value=sample_valid,
        ) as validate_method:
    ...
    def test_find_by_email(self):
        ...
        sample_usuario = Usuario(
            id=1, name="John Doe", email=sample_email, password="123456", is_admin=False
        )
    ...
    def test_update_password(self):
        ...
        with mock.patch.object(
            self.__controller,
            "_UsuarioController__password_service",
            ...
            self.__repository.update_usuario_password.assert_called_once_with(
                usuario_id, hashed_new_password
            )
